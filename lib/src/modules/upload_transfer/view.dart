...
class UploadTransferPage extends StatelessWidget {
  ...
  const UploadTransferPage(
      {required this.code, required this.fromSuccessOrder, required this.total, Key? key})
      : super(key: key);
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                CustomText(
                                                  logic.banksList[index].bank?.name,
                                                  fontWeight: FontWeight.bold,
                                                ),
                                                CustomText(
                                                  "اسم المحول له: ".tr +
                                                      (logic.banksList[index].beneficiaryName ??
                                                          ''),
                                                  fontSize: 11,
                                                ),
                                              ],
                                          ...
                                          CustomImage(
                                            url: logic.banksList[index].bank?.logo ?? '',
                                            height: 30,
                                            size: 20,
                                          )
                                        ],
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(
                                                child: CustomText(
                                              logic.banksList[index].accountNumber,
                                              fontSize: 10,
                                            )),
                                            const SizedBox(
                                              width: 5,
                                            ...
                                            InkWell(
                                                onTap: () {
                                                  Clipboard.setData(ClipboardData(
                                                      text: logic.banksList[index].accountNumber));
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            InkWell(
                                                onTap: () {
                                                  Clipboard.setData(ClipboardData(
                                                      text: logic.banksList[index].iban));
                                                  showMessage('Copied', 1);
                                                },
                                                child: const Icon(Icons.copy_outlined)),
                                          ],
                        ...
                        : DropdownButtonHideUnderline(
                            child: DropdownButton2(
                              ...
                              dropdownDecoration: BoxDecoration(
                                  color: dropdownColor, borderRadius: BorderRadius.circular(15.sp)),
                              hint: Container(
                                decoration: BoxDecoration(
                              ...
                              items: logic.banksList.map((BankResponseModel selectedType) {
                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: TextFormField(
                                enabled: false,
                                controller: TextEditingController(text: logic.image?.name),
                                validator: Validation.nameValidate,
