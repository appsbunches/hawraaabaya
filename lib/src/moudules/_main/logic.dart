...
import 'package:entaj/src/moudules/wishlist/view.dart';
...
class MainLogic extends GetxController {
      ...
      case 0:
        {
          ...
          if(homeScreenModel == null && homeScreenOldThemeModel == null){
            getHomeScreen(themeId: AppConfig.currantThemeId);
  ...
  saveCountry() async {
    ...
    try {
      ...
      getStoreSetting();
      getCategories();
      _deliveryOptionLogic.getShippingMethods(true);
