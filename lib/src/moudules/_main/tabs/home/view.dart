...
import 'package:entaj/src/moudules/_main/widgets/featured_products_wigget.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppConfig.liteVersion ? const CategoryDetailsPage(hideHeaderFooter: true,) : GetBuilder<MainLogic>(
                    ...
                    : (AppConfig.isSoreUseNewTheme)
                        ...
                        : Column(
                            children: [
                              ...
                              if (logic.homeScreenModel?.products == null && logic.slider != null)
                                GetBuilder<HomeLogic>(
                                    init: Get.find<HomeLogic>(),
                                    builder: (logic) {
                                ...
                                GetBuilder<MainLogic>(builder: (logic) {
                                  return Column(
                                    ...
                                    children: [
                                      ...
                                      FeaturedProductsWidget(
                                          featuredProducts: logic.homeScreenModel?.onSaleProducts),
                                      FeaturedProductsWidget(
                                          featuredProducts:
                                      ...
                                      FeaturedProductsWidget(
                                          featuredProducts: logic.homeScreenModel?.recentProducts),
                                    ],
                                  );
                                }),
                              if (logic.homeScreenModel?.products == null)
